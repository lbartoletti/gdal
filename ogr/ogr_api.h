...
OGRGeometryH CPL_DLL OGR_G_ApproximateArcAngles(
    ...
    double dfEndAngle, double dfMaxAngleStepSizeDegrees) CPL_WARN_UNUSED_RESULT;

OGRGeometryH CPL_DLL OGR_G_ForceToPolygon(OGRGeometryH) CPL_WARN_UNUSED_RESULT;
OGRGeometryH
    CPL_DLL OGR_G_ForceToLineString(OGRGeometryH) CPL_WARN_UNUSED_RESULT;
OGRGeometryH
    CPL_DLL OGR_G_ForceToMultiPolygon(OGRGeometryH) CPL_WARN_UNUSED_RESULT;
OGRGeometryH
...
OGRErr CPL_DLL OGR_G_ExportToWkb(OGRGeometryH, OGRwkbByteOrder,
                                 unsigned char *);
...
OGRGeometryH CPL_DLL OGR_G_CreateGeometryFromEsriJson(const char *)
    CPL_WARN_UNUSED_RESULT;
...
OGR_GeomTransformer_Transform(OGRGeomTransformerH hTransformer,
                              OGRGeometryH hGeom) CPL_WARN_UNUSED_RESULT;
...
OGRGeometryH CPL_DLL OGR_G_Simplify(OGRGeometryH hThis,
                                    double tolerance) CPL_WARN_UNUSED_RESULT;
OGRGeometryH CPL_DLL OGR_G_SimplifyPreserveTopology(
    OGRGeometryH hThis, double tolerance) CPL_WARN_UNUSED_RESULT;
OGRGeometryH CPL_DLL
...
int CPL_DLL OGR_G_GetPoints(OGRGeometryH hGeom, void *pabyX, int nXStride,
                            void *pabyY, int nYStride, void *pabyZ,
                            int nZStride);
int CPL_DLL OGR_G_GetPointsZM(OGRGeometryH hGeom, void *pabyX, int nXStride,
                              void *pabyY, int nYStride, void *pabyZ,
...
void CPL_DLL OGR_G_GetPoint(OGRGeometryH, int iPoint, double *, double *,
                            double *);
...
OGRGeometryH CPL_DLL OGRBuildPolygonFromEdges(
    ...
    double dfTolerance, OGRErr *peErr) CPL_WARN_UNUSED_RESULT;
...
OGRFieldDefnH CPL_DLL OGR_Fld_Create(const char *,
                                     OGRFieldType) CPL_WARN_UNUSED_RESULT;
...
OGRGeomFieldDefnH CPL_DLL OGR_GFld_Create(const char *, OGRwkbGeometryType)
    CPL_WARN_UNUSED_RESULT;
...
OGRGeometryH CPL_DLL OGR_F_StealGeometryEx(OGRFeatureH, int iGeomField)
    CPL_WARN_UNUSED_RESULT;
...
void CPL_DLL OGR_F_SetFieldDateTime(OGRFeatureH, int, int, int, int, int, int,
                                    int, int);
void CPL_DLL OGR_F_SetFieldDateTimeEx(OGRFeatureH, int, int, int, int, int, int,
                                      float, int);
...
OGRErr CPL_DLL OGR_F_SetGeomFieldDirectly(OGRFeatureH hFeat, int iField,
                                          OGRGeometryH hGeom);
...
void CPL_DLL OGR_FldDomain_SetSplitPolicy(OGRFieldDomainH,
                                          OGRFieldDomainSplitPolicy);
OGRFieldDomainMergePolicy CPL_DLL OGR_FldDomain_GetMergePolicy(OGRFieldDomainH);
void CPL_DLL OGR_FldDomain_SetMergePolicy(OGRFieldDomainH,
                                          OGRFieldDomainMergePolicy);

OGRFieldDomainH CPL_DLL OGR_CodedFldDomain_Create(
...
OGRFieldDomainH CPL_DLL OGR_RangeFldDomain_Create(
    const char *pszName, const char *pszDescription, OGRFieldType eFieldType,
    OGRFieldSubType eFieldSubType, const OGRField *psMin, bool bMinIsInclusive,
    const OGRField *psMax, bool bMaxIsInclusive);
const OGRField CPL_DLL *OGR_RangeFldDomain_GetMin(OGRFieldDomainH,
                                                  bool *pbIsInclusiveOut);
const OGRField CPL_DLL *OGR_RangeFldDomain_GetMax(OGRFieldDomainH,
                                                  bool *pbIsInclusiveOut);
...
OGRGeometryTypeCounter CPL_DLL *
...
void CPL_DLL OGR_L_SetSpatialFilterRect(OGRLayerH, double, double, double,
                                        double);
...
OGRErr CPL_DLL OGR_L_ReorderField(OGRLayerH, int iOldFieldPos,
                                  int iNewFieldPos);
OGRErr CPL_DLL OGR_L_AlterFieldDefn(OGRLayerH, int iField,
                                    OGRFieldDefnH hNewFieldDefn, int nFlags);
OGRErr CPL_DLL OGR_L_AlterGeomFieldDefn(OGRLayerH, int iField,
...
OGRLayerH CPL_DLL OGR_DS_ExecuteSQL(OGRDataSourceH, const char *, OGRGeometryH,
                                    const char *);
...
OGRDataSourceH CPL_DLL OGR_Dr_Open(OGRSFDriverH, const char *,
...
OGRDataSourceH CPL_DLL OGROpen(const char *, int,
                               OGRSFDriverH *) CPL_WARN_UNUSED_RESULT;
OGRDataSourceH CPL_DLL OGROpenShared(const char *, int,
                                     OGRSFDriverH *) CPL_WARN_UNUSED_RESULT;
...
const char CPL_DLL *OGR_ST_GetParamStr(OGRStyleToolH hST, int eParam,
                                       int *bValueIsNull);
int CPL_DLL OGR_ST_GetParamNum(OGRStyleToolH hST, int eParam,
                               int *bValueIsNull);
double CPL_DLL OGR_ST_GetParamDbl(OGRStyleToolH hST, int eParam,
                                  int *bValueIsNull);
void CPL_DLL OGR_ST_SetParamStr(OGRStyleToolH hST, int eParam,
                                const char *pszValue);
...
int CPL_DLL OGR_STBL_AddStyle(OGRStyleTableH hStyleTable, const char *pszName,
                              const char *pszStyleString);
